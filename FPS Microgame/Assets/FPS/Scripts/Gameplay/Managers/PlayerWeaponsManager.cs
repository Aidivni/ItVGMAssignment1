...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        [Header("No Overheat Powerup")]
        public AudioSource AudioSource;
        public bool overheatOff = false;
        public float overheatOffTimer = 10;
        ...
        void Update()
        {
            ...
            if (overheatOff && overheatOffTimer > 0f)
            {
                overheatOffTimer -= Time.deltaTime;
                activeWeapon.m_CurrentAmmo = activeWeapon.MaxAmmo;
            }
            else if (overheatOff && overheatOffTimer <= 0f)
            {
                overheatOff = false;
                overheatOffTimer = 10f;
                m_PlayerCharacterController.AudioSource.Stop();
            }
        }
